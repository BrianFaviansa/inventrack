                ...
                ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <!-- Modal delete toggle -->
                            <button data-modal-target="deleteBarang<?= $barang['id_barang']; ?>" data-modal-toggle="deleteBarang<?= $barang['id_barang']; ?>" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" type="button">
                                Hapus
                            </button>

                            <!-- modal delete -->
                            <div id="deleteBarang<?= $barang['id_barang']; ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="deleteBarang<?= $barang['id_barang']; ?>">
                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                            </svg>
                                            <span class="sr-only">Close modal</span>
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <form action="<?= urlpath('destroyBarang'); ?>" method="post">
                                                ...
                                                <button data-modal-hide="deleteBarang<?= $barang['id_barang']; ?>" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                    Ya
                                                </button>
                                                <button data-modal-hide="deleteBarang<?= $kategori['id_kategori']; ?>" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"> Tidak</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
        ...
        gambars.forEach(element => {
            element.addEventListener('change', function() {
                ...
                if (file) {
                    ...
                    fileReaders.push(reader); // Keep a reference to the FileReader instance
                ...
                if (modal) {
                    modal.addEventListener('hidden.bs.modal', function() {
                        ...
                        fileReaders.forEach(reader => {
                            reader.abort(); // Cancel the FileReader
                        });
                        fileReaders = []; // Reset the fileReaders array
                    });
                }
            });
        });
