...
<div class="mt-18">
    ...
    <section id="home" class="bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">We Track Your Company Inventory</h1>
            <p class="mb-8 text-lg font-normal text-center text-gray-300 lg:text-xl sm:px-16 lg:px-48">Here at Inventrack we focus
                on providing efficient inventory management solutions for businesses of all sizes. Whether you're a small startup or a large corporation, we have the tools and expertise to help you keep track of your company's inventory. Our software is designed to streamline the inventory management process, saving you time and money. With Inventrack, you can easily track stock levels, manage orders, and generate reports to gain valuable insights into your business. Start optimizing your inventory management today and experience the benefits of Inventrack.</p>
    ...
    <section id="about" class="py-10 dark:bg-gray-800">
        ...
        <div class="container mx-8 md:mx-auto sm:grid-cols-2 md:justify-items-center grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div class="max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <a href="#">
                    <h5 class="mb-2 mt-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Awarded Agency</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Divide details about your product or agency work into parts. A paragraph describing a feature will be enough.</p>
            </div>

            <div class="max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 md:-translate-y-10">
                <div class="rounded-full w-14 h-14 mx-auto flex justify-center items-center bg-sky-300" src="">
                    <svg class="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 mt-2 dark:text-white">Free Revisions</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Keep you user engaged by providing meaningful information. Remember that by this time, the user is curious.</p>

            </div>

            <div class="max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="rounded-full w-14 h-14 flex justify-center items-center mx-auto bg-green-300" src="">
                    <svg class="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <a href="#">
                    <h5 class="mb-2 mt-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Verified Company</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Write a few lines about each one. A paragraph describing a feature will be enough. Keep you user engaged!</p>
            </div>
        </div>
    </section>
    ...
    <!-- testimony -->
    <section id="testimony" class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm">
                <h2 class="mb-4 mt-2 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Testimonials</h2>
    ...
    <section id="pricing" class="bg-gray-100 dark:bg-gray-900 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                <!-- Free Plan -->
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
                    <div class="mb-8">
                    ...
                    <div class="mb-8">
                        ...
                        <span class="text-xl font-medium text-gray-600 dark:text-gray-400">/mo</span>
                    </div>
                    <ul class="mb-8 space-y-4 text-gray-600 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
                    <div class="mb-8">
                        ...
                        <p class="mt-4 text-gray-600 dark:text-gray-400">Ideal for growing businesses and enterprises.</p>
                    </div>
                    <div class="mb-8">
                        <span class="text-5xl font-extrabold text-gray-900 dark:text-white">$99</span>
                        <span class="text-xl font-medium text-gray-600 dark:text-gray-400">/mo</span>
                    </div>
                    <ul class="mb-8 space-y-4 text-gray-600 dark:text-gray-400">
                        <li class="flex items-center">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
                    <div class="mb-8">
                        ...
                        <p class="mt-4 text-gray-600 dark:text-gray-400">Tailored for large-scale deployments and custom needs.</p>
                    </div>
                    <div class="mb-8">
